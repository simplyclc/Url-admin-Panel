...
const navigation = [
    ...
    { name: 'Update Application', href:'update', icon: ClipboardDocumentIcon, current: false },
...
export default function StudentAuthLayout({ user, header, breadcrumb, children }) {
      ...
      */}
      <div>
                                ...
                                <a
                                  ...
                                  className={classNames(
                                    item.current
                                      ...
                                      : 'text-gray-700 hover:text-white hover:bg-red-700',
                      ...
                      <li key={item.name}>
                        <a
                          ...
                          className={classNames(
                            item.current
                            ? 'bg-red-700 text-white'
                            : 'text-gray-800 hover:text-white hover:bg-red-700',
                          'group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold'
                          )}
                        >
                          <item.icon className="h-6 w-6 shrink-0" aria-hidden="true" />
        ...
        <div className="xl:pl-72">
          ...
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-6 border-b border-black/5 bg-red-800 px-4 shadow-sm sm:px-6 lg:px-8">
